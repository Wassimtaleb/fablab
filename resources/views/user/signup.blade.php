...
<head>
    ...
    <title>Créer un compte - FabLab</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-sm bg-white rounded-xl shadow p-6 text-sm">
        ...
        <div class="mt-3 text-center w-full block">
            <a href="{{ route('user.login') }}" class="text-xs text-blue-600 hover:underline w-full block">Retour à la connexion</a>
        </div>
    </div>
</body>
</html>