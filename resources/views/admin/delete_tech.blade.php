...
<head>
    ...
    <title>Supprimer un Technicien - FabLab</title>
...
<body class="bg-gray-100">
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="bg-red-600 text-white p-4">
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-bold">Supprimer un Technicien</h1>
            ...
            <div class="p-6">
                <h2 class="text-lg font-semibold mb-4">Sélectionner un technicien à supprimer</h2>
                                ...
                                @foreach($techniciens as $technicien)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="py-2 px-4 border-b text-center">
                                            <button 
                                                class="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600 delete-tech"
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-700">
                                Attention : Cette action est irréversible. Êtes-vous sûr de vouloir supprimer ce technicien ?
                            </p>
                        </div>
                    </div>
                </div>
                <form id="delete-form" method="POST" action="{{ route('admin.techniciens.destroy') }}" class="space-y-4">
                    @csrf
                    @method('DELETE')
                    ...
                    <div>
                        <p class="text-gray-700">Vous êtes sur le point de supprimer le technicien :</p>
                        <p class="font-semibold mt-2" id="tech-info"></p>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const deleteButtons = document.querySelectorAll('.delete-tech');
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    // Remplir les informations du technicien
                    techInfoElement.textContent = `${prenom} ${nom} (${email})`;
