...
<head>
    ...
    <title>Modifier un Utilisateur - FabLab</title>
...
<body class="bg-gray-100">
    <div class="min-h-screen p-6">
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-6">
                <h2 class="text-lg font-semibold mb-4">Sélectionner un utilisateur à modifier</h2>
                                ...
                                @foreach($users as $user)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="py-2 px-4 border-b text-center">
                                            <button 
                                                class="bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600 edit-user"
                                                data-id="{{ $user->id }}"
                                                data-nom="{{ $user->nom }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    editForm.action = "{{ url('admin/users/update') }}/" + id;
