...
<head>
    ...
    <title>Modifier un Administrateur - FabLab</title>
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="bg-blue-600 text-white p-4">
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-bold">Modifier un Administrateur</h1>
            ...
            <div class="p-6">
                <h2 class="text-lg font-semibold mb-4">Sélectionner un administrateur à modifier</h2>
                                ...
                                @foreach($admins as $admin)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="py-2 px-4 border-b text-center">
                                            <button 
                                                class="bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600 edit-admin"
                                                data-id="{{ $admin->id }}"
                                                data-nom="{{ $admin->nom }}"
            ...
            <div id="edit-form-container" class="hidden p-6 bg-gray-50 border-t">
                <h2 class="text-lg font-semibold mb-4">Modifier l'administrateur</h2>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    editForm.action = "{{ url('admin/update') }}/" + id;
