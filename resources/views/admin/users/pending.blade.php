...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Utilisateurs en attente d'activation</h2>
            <p class="text-gray-600">Activez ou supprimez les comptes utilisateurs nouvellement créés.</p>
        </div>
